...
<Image src={UPC_logo_Trans} width={20} height={40} alt="UPC logo" style={{marginRight: "10px"}} />
      ...
      <div className=" relative z-10  mx-auto mt-[150px] w-full  max-w-7xl p-4 pt-20 md:pt-0">
        <h1
          data-aos="fade-up"
          className=" animate__animated animate__zoomInDown  bg-gradient-to-b from-[#0752E9] to-neutral-400 bg-clip-text text-center text-4xl font-bold text-transparent md:text-9xl"
        >
          Learn
        </h1>
        <h1
        ...
        <h1
          data-aos="fade-up"
          className=" animate__animated animate__zoomInUp   animate__delay-1s   bg-gradient-to-b from-neutral-50 to-[#62E2E9] bg-clip-text text-center text-4xl font-bold text-transparent md:text-9xl"
        >
          Grow
        </h1>
